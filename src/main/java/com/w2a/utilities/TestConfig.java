...
public class TestConfig{
	...
	public static String from = "shiivamsundaram@gmail.com";
	public static String password = "Softwaretesting01";
	public static String[] to ={"reddy_vam1@gmail.com","vamshi4ru@yahoo.com"};
